    ...
    experience: {
      ...
      jobs: [
        ...
        },
        {
          ...
          description: "Working as a Software Engineer at EXTFOX, focusing on software development and Shopify solutions.",
          points: [
            "Developing and maintaining production software.",
            "Building and supporting Shopify themes/apps and integrations.",
            "Collaborating with the team to design and deliver new features.",
    ...
    experience: {
      ...
      jobs: [
        ...
        },
        {
          title: "Софтверски Инженер",
          company: "EXTFOX",
          duration: "Мај 2025 - Моментално",
          description: "Работам како софтверски инженер во EXTFOX, со фокус на развој на софтвер и Shopify решенија.",
          points: [
            "Развој и одржување на продукциски софтвер.",
            "Развој и поддршка на Shopify теми/апликации и интеграции.",
            "Соработка со тимот за дизајн и имплементација на нови функционалности.",
            "Пишување чист и одржлив код и учество во code review.",
          ],
        },
      ],
    },
