...
const messages = {
  ...
  mk: {
    ...
    experience: {
      ...
      jobs: [
        {
          title: "Интерн за софтверски инженер",
          company: "ИнТек Систем",
          duration: "Март 2024 - Јуни 2024 • Скопје, Македонија",
          description: "Работев како интерн за софтверски инженер во ИнТек Систем.",
          points: [
            "Развивав системи за управување со документи (DMS) и автоматизација на процеси.",
            "Се фокусирав на фронт-енд развој користејќи React.",
