<template>
  <div class="w-1/12 justify-end md:flex">
    <button class="theme-toggle rounded bg-gray-700 dark:bg-gray-800 p-2 md:mr-4 hover:bg-gray-600 dark:hover:bg-gray-700" @click="toggleTheme">
      <div class="sun-moon">
