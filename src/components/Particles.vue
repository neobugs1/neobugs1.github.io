<template>
  <div
    id="screen"
    class="relative flex flex-col items-center justify-center bg-gradient-to-r from-green-400 to-green-600 dark:bg-gradient-to-r dark:from-gray-700 dark:to-gray-900"
  >
